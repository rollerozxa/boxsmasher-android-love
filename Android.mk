...
LOCAL_CFLAGS    := -fexceptions -g -DGL_GLEXT_PROTOTYPES -DAL_ALEXT_PROTOTYPES -fvisibility=hidden
...
LOCAL_STATIC_LIBRARIES := libopenal libvorbis libvorbisfile libogg libfreetype libluajit SDL2_static

# $(info liblove: include dirs $(LOCAL_C_INCLUDES))
# $(info liblove: src files $(LOCAL_SRC_FILES))

LOCAL_LDLIBS := -lz -lGLESv1_CM -lGLESv2 -ldl -landroid -lOpenSLES
